...
func on_input(_event: InputEvent) -> void:
	...
	elif Input.is_action_pressed("ui_accept") and Input.is_action_pressed("ui_down") or Input.is_action_pressed("ui_up") or Input.is_action_pressed("ui_left") or Input.is_action_pressed("ui_right"):
